...
layout: single
published: true
title:  "[CS]네트워크 계층(TCP/IP, OSI 7계층), 캡슐화/비캡슐화"
categories: network
...
<p align="center"><img src="https://github.com/user-attachments/assets/7cb3eeb4-9f4e-4694-81db-f0f1f26176d5" width="60%" height="60%"></p>
...
- 과정:
  1. 응용 계층: 데이터 생성
  2. 전송 계층: TCP/UDP 헤더 추가 (세그먼트/데이터그램 생성)
  3. 인터넷 계층: IP 헤더 추가 (패킷 생성)
  4. 네트워크 인터페이스 계층: 이더넷 헤더와 트레일러 추가 (프레임 생성)

```
[이더넷 헤더][IP 헤더][TCP/UDP 헤더][데이터][이더넷 트레일러]
```
